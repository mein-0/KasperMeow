...
The decrypted log contains multiple kernel-space addresses (0xFFFF...) — driver bases, kernel object pointers, and internal offsets. These defeat KASLR and can be used as primitives for kernel exploit chains.

## Disclosure

- Reported to Kaspersky PSIRT — marked as **duplicate**
